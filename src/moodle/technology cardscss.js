...
export default function Technology_Cardscss()
{
    return(
      <div>
       
        <div className="container-fluid tech-parent pb-5">
           ...
           <div class="row">
  <div class="col-sm-6">
    <div class="card tech-cord1">
      <div class="card-body ">
        <h5 class="card-title tech-tittle">Data Scientist</h5>
  ...
  <div class="col-sm-6">
    <div class="card tech-cord1">
      <div class="card-body">
        <h5 class="card-title tech-tittle">IOT Developer</h5>
  ...
  <div class="col-sm-6 ">
    <div class="card tech-cord1">
      <div class="card-body ">
        <h5 class="card-title tech-tittle">VR Developer</h5>
  ...
  <div class="col-sm-6">
    <div class="card tech-cord1">
      <div class="card-body">
        <h5 class="card-title tech-tittle">ML Engineer</h5>
